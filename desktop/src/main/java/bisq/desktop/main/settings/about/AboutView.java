...
public class AboutView extends ActivatableView<GridPane, Void> {
    ...
    public void initialize() {
        ...
        HyperlinkWithIcon hyperlinkWithIcon = addHyperlinkWithIcon(root, ++gridRow, Res.get("setting.about.web"), "https://github.com/c4pt000/electrum-bitnet");
        GridPane.setColumnSpan(hyperlinkWithIcon, 2);
        hyperlinkWithIcon = addHyperlinkWithIcon(root, ++gridRow, Res.get("setting.about.code"), "https://github.com/c4pt000/bitnet");
        GridPane.setColumnSpan(hyperlinkWithIcon, 2);
        ...
        GridPane.setColumnSpan(label, 2);
        GridPane.setHalignment(label, HPos.LEFT);
        hyperlinkWithIcon = addHyperlinkWithIcon(root, ++gridRow, Res.get("setting.about.contribute"), "zelle or google pay -> harley0006@gmail.com");
        GridPane.setColumnSpan(hyperlinkWithIcon, 2);

        boolean isBtc = Res.getBaseCurrencyCode().equals("BITN");
        ...
        if (isBtc)
            addCompactTopLabelTextField(root, ++gridRow, Res.get("setting.about.feeEstimation.label"), "mempool.space (http://radioblockchain.info");
