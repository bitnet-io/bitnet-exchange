...
public class FeeService {
    ...
    private static final long BTC_DEFAULT_TX_FEE = 550;
    ...
    private long txFeePerVbyte = 550;
//BTC_DEFAULT_TX_FEE;
...
// map.get(Config.BTC_MIN_TX_FEE);
                    ...
                    log.info("BIT tx fee: txFeePerVbyte={} minFeePerVbyte={}", txFeePerVbyte, minFeePerVByte);
                    success();
                });
            }
